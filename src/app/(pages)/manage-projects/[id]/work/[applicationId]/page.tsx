  ...
  return (
    <div className="min-h-screen bg-gray-50/30 pb-20 selection:bg-blue-100 selection:text-blue-600">
      ...
      <div className="md:hidden">
        ...
        <Link
          href={`/account/${
            isFreelancer ? workData.jobId?.ownerId : workData.applicantId?._id
          }`}
          className="block"
        >
          <motion.div
        ...
        <main className="px-4 py-4 space-y-4">
            ...
            <div className="rounded-2xl bg-white border border-gray-100 shadow-sm p-4">
              ...
              <p
                className={`text-sm font-bold ${
                  workData.status === "in_progress"
                    ? "text-blue-600"
                    : workData.status === "submitted"
                    ? "text-purple-600"
                    : workData.status === "revision"
                    ? "text-orange-600"
          ...
          >
            ...
            {/* Edit Mode Content */}
            {isFreelancer &&
              !["completed", "submitted"].includes(workData.status) && (
                <>
                  {!isEditingProgress ? (
                    <>
            ...
            (["in_progress", "revision", "accepted"].includes(
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-xs text-gray-500 mb-2">
                    แนบลิงก์ผลงาน (Drive, Figma, Github)
                  </p>
              ...
              <div className="space-y-3">
                {workData.workLink && (
                  ...
                  >
                    <span className="font-bold text-blue-700 truncate mr-3 text-sm">
                      {workData.workLink}
                    </span>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mt-6">
              ...
              <Link
                href={`/account/${
                  isFreelancer
                    ? workData.jobId?.ownerId
                    : workData.applicantId?._id
                }`}
              ...
              <div className="flex justify-between items-center px-8 pt-8 pb-5">
                ...
                <div className="relative inline-block">
                  <motion.span
                    ...
                    className="text-2xl font-black tabular-nums block relative z-10"
                    style={{
                      color: newProgress === 100 ? "#16a34a" : "#2563eb",
                    }}
                  >
                    {newProgress}
              ...
              <div className="flex items-center justify-between gap-3 mb-4">
                ...
                <span
                  className={`text-xs px-2.5 py-1 rounded-lg border ${
                    statusLabel[workData.status]?.class
                  }`}
                >
                  {statusLabel[workData.status]?.text}
                </span>
