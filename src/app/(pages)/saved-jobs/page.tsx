    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white pb-20">
      <section className="relative overflow-hidden py-20 px-10 text-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <Link
            href="/find-job"
            className="inline-flex items-center text-blue-600 font-bold text-sm mb-6 hover:gap-2 transition-all"
          >
          ...
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tight leading-tight">
            งานที่{" "}
            <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500 py-2">
              คุณบันทึกไว้
            </span>
          </h1>
